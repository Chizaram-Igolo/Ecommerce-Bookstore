...
export default function NavMenu({ selected }: { selected: ReactElement }) {
  return (
    <>
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute left-0 z-50 mt-4">
                <div
                  className="w-[24em] overflow-hidden shadow-lg 
